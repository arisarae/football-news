...
SECRET_KEY = 'django-insecure-tl#hz^x0o#c9$u)eo8686-@9g05j6v5jyrp&f!!+hh#=l&@3_7'
...
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "arisa-raezzura-footballnews.pbp.cs.ui.ac.id", "10.0.2.2"]

CSRF_TRUSTED_ORIGINS = ["https://arisa-raezzura-footballnews.pbp.cs.ui.ac.id"]
